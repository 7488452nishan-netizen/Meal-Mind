...
const translations = {
    ...
    bn: {
        ...
        shopping_list_empty_desc: "שুরু করতে উপরে আইটেম যোগ করুন।",
    ...
    de: {
        ...
        toast_login_fail: "Ungültige Anmeldeinformationen.",
        toast_signup_success: "Konto erfolgreich erstellt!",
        toast_payment_submitted: "Zahlung zur Überprüfung eingereicht.",
        toast_sub_approved: "Abonnement genehmigt!",
        toast_sub_rejected: "Abonnement abgelehnt.",
        toast_sub_updated: "Benutzerabonnement aktualisiert.",
        toast_payment_method_added: "Zahlungsmethode hinzugefügt.",
        toast_payment_method_removed: "Zahlungsmethode entfernt.",
        toast_timer_finished: "Timer beendet!",
        toast_admin_add_method_fail_fields_required: "Name und Details sind erforderlich.",
    },
    it: {
        nav_home: "Home",
        nav_home_mobile: 'Home',
        ...
        // Toasts
        toast_login_success: "Accesso riuscito!",
        toast_login_fail: "Credenziali non valide.",
        toast_signup_success: "Account creato con successo!",
        toast_payment_submitted: "Pagamento inviato per la revisione.",
        toast_sub_approved: "Abbonamento approvato!",
        toast_sub_rejected: "Abbonamento rifiutato.",
        toast_sub_updated: "Abbonamento utente aggiornato.",
        toast_payment_method_added: "Metodo di pagamento aggiunto.",
        toast_payment_method_removed: "Metodo di pagamento rimosso.",
        toast_timer_finished: "Timer terminato!",
        toast_admin_add_method_fail_fields_required: "Sono richiesti sia il nome che i dettagli.",
    },
    pt: {
        nav_home: "Início",
        ...
        // Toasts
        toast_login_success: "Login bem-sucedido!",
        toast_login_fail: "Credenciais inválidas.",
        toast_signup_success: "Conta criada com sucesso!",
        toast_payment_submitted: "Pagamento enviado para revisão.",
        toast_sub_approved: "Assinatura aprovada!",
        toast_sub_rejected: "Assinatura rejeitada.",
        toast_sub_updated: "Assinatura do usuário atualizada.",
        toast_payment_method_added: "Método de pagamento adicionado.",
        toast_payment_method_removed: "Método de pagamento removido.",
        toast_timer_finished: "Temporizador concluído!",
        toast_admin_add_method_fail_fields_required: "O nome e os detalhes são obrigatórios.",
    },
    ko: {
        nav_home: "홈",
        nav_home_mobile: '홈',
        ...
        toast_login_fail: "잘못된 자격 증명입니다.",
        toast_signup_success: "계정이 성공적으로 생성되었습니다!",
        toast_payment_submitted: "결제가 검토를 위해 제출되었습니다.",
        toast_sub_approved: "구독이 승인되었습니다!",
        toast_sub_rejected: "구독이 거부되었습니다.",
        toast_sub_updated: "사용자 구독이 업데이트되었습니다.",
        toast_payment_method_added: "결제 수단이 추가되었습니다.",
        toast_payment_method_removed: "결제 수단이 제거되었습니다.",
        toast_timer_finished: "타이머가 종료되었습니다!",
        toast_admin_add_method_fail_fields_required: "이름과 세부 정보가 모두 필요합니다.",
    },
    zh: {
        nav_home: "首页",
        nav_home_mobile: '首页',
        ...
        toast_login_fail: "凭证无效。",
        toast_signup_success: "帐户创建成功！",
        toast_payment_submitted: "付款已提交审核。",
        toast_sub_approved: "订阅已批准！",
        toast_sub_rejected: "订阅被拒绝。",
        toast_sub_updated: "用户订阅已更新。",
        toast_payment_method_added: "已添加付款方式。",
        toast_payment_method_removed: "付款方式已删除。",
        toast_timer_finished: "计时器已完成！",
        toast_admin_add_method_fail_fields_required: "名称和详细信息均为必填项。",
    },
    hi: {
        nav_home: "होम",
        nav_home_mobile: 'होम',
        ...
        toast_login_fail: "अमान्य क्रेडेंशियल।",
        toast_signup_success: "खाता सफलतापूर्वक बनाया गया!",
        toast_payment_submitted: "भुगतान समीक्षा के लिए प्रस्तुत किया गया।",
        toast_sub_approved: "सदस्यता स्वीकृत!",
        toast_sub_rejected: "सदस्यता अस्वीकृत।",
        toast_sub_updated: "उपयोगकर्ता सदस्यता अद्यतन।",
        toast_payment_method_added: "भुगतान विधि जोड़ी गई।",
        toast_payment_method_removed: "भुगतान विधि हटा दी गई।",
        toast_timer_finished: "टाइमर समाप्त!",
        toast_admin_add_method_fail_fields_required: "नाम और विवरण दोनों आवश्यक हैं।",
    },
    ar: {
        nav_home: "الرئيسية",
        ...
        toast_login_fail: "بيانات الاعتماد غير صالحة.",
        toast_signup_success: "تم إنشاء الحساب بنجاح!",
        toast_payment_submitted: "تم إرسال الدفعة للمراجعة.",
        toast_sub_approved: "تمت الموافقة على الاشتراك!",
        toast_sub_rejected: "تم رفض الاشتراك.",
        toast_sub_updated: "تم تحديث اشتراك المستخدم.",
        toast_payment_method_added: "تمت إضافة طريقة الدفع.",
        toast_payment_method_removed: "تمت إزالة طريقة الدفع.",
        toast_timer_finished: "انتهى الموقت!",
        toast_admin_add_method_fail_fields_required: "مطلوب كل من الاسم والتفاصيل.",
    }
};
